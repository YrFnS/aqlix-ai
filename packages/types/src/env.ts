...
export const EnvironmentUtils = {
   ...
   */
  isProduction: (env: EnvironmentType): boolean => env === "production",

  /**
   * Check if environment is development
   */
  isDevelopment: (env: EnvironmentType): boolean => env === "development",

  /**
   * Check if environment is test
   */
  isTest: (env: EnvironmentType): boolean => env === "test",
   ...
   */
  parseBoolean: (value: string): boolean => value === "true",
} as const;
...
export const EnvironmentValidation = {
   ...
   */
  isValidApiKey: (key: string, minLength = 32): boolean => {
