...
class CulturalIntelligenceProcessor:
    ...
    def calculate_cultural_compliance_score(
        ...
        try:
            ...
            overall_score = (
                ...
                + linguistic_score
                * CULTURAL_THEMES["linguistic_appropriateness"]["weight"]
            )
    ...
    def _generate_recommendations(
        self, overall: float, islamic: float, cultural: float, professional: float
    ) -> List[str]:
        ...
        if islamic < 0.90:
            recommendations.append(
                "Consider adding Islamic values alignment and respectful religious references"
            )

        if cultural < 0.90:
            recommendations.append(
                "Enhance Iraqi cultural context and traditional values representation"
            )

        if professional < 0.90:
            recommendations.append(
                "Improve professional domain relevance and terminology usage"
            )

        if overall >= 0.95:
            recommendations.append(
                "Excellent cultural compliance - content is well-aligned with Iraqi standards"
            )
    ...
    def _get_islamic_analysis(self, content: str) -> Dict[str, Any]:
        ...
        return {
            "islamic_references_detected": bool(
                any(
                    keyword in content.lower()
                    for keyword in CULTURAL_THEMES["islamic_values"]["keywords"]
                )
            ),
    ...
    def _get_cultural_analysis(self, content: str) -> Dict[str, Any]:
        ...
        return {
            "iraqi_context_awareness": bool(
                any(
                    keyword in content.lower()
                    for keyword in CULTURAL_THEMES["iraqi_culture"]["keywords"]
                )
            ),
...
def register_cultural_tools(mcp: FastMCP):
    ...
    async def iraqi_cultural_validation(
        ...
        try:
            ...
            compliance_analysis = (
                cultural_processor.calculate_cultural_compliance_score(content, domain)
            )

            # Check thresholds
            cultural_compliant = (
                compliance_analysis["overall_cultural_compliance"] >= 0.95
            )
            ...
            return json.dumps(
                {
                    ...
                    "cultural_validation": {
                        ...
                        "cultural_compliance_score": compliance_analysis[
                            "overall_cultural_compliance"
                        ],
                        "islamic_compliance_score": compliance_analysis[
                            "islamic_compliance_score"
                        ],
                        "iraqi_cultural_score": compliance_analysis[
                            "iraqi_cultural_score"
                        ],
                        "professional_domain_score": compliance_analysis[
                            "professional_domain_score"
                        ],
    ...
    async def islamic_compliance_check(
        ctx: Context, content: str, context_type: str = "general"
    ) -> str:
        """
        ...
        try:
            ...
            compliance_analysis = (
                cultural_processor.calculate_cultural_compliance_score(content)
            )
            ...
            if islamic_score >= 0.95:
                ...
                compliance_status = (
                    "Good - Generally compliant with minor considerations"
                )
            else:
                compliance_status = (
                    "Needs Improvement - Requires Islamic values alignment"
                )
            ...
            return json.dumps(
                {
                    ...
                    "islamic_compliance": {
                        ...
                        "islamic_values_analysis": compliance_analysis[
                            "detailed_analysis"
                        ]["islamic_values_analysis"],
                        "recommendations": [
                            rec
    ...
    async def professional_domain_validation(
        ctx: Context, content: str, domain: str, expertise_level: str = "professional"
    ) -> str:
        """
            ...
            return json.dumps(
                {
                    ...
                    "professional_domain_validation": {
                        ...
                        "domain_specific_analysis": self._get_domain_specific_analysis(
                            domain, content
                        ),
    ...
    def _get_domain_specific_analysis(
        ...
        return domain_analysis.get(
            domain, {"analysis": "General professional context maintained"}
        )

    # Log successful registration
    logger.info(
        "✓ Iraqi Cultural Intelligence tools registered (5 comprehensive tools)"
    )
