...
IRAQI_PROFESSIONAL_DOMAINS = {
    "legal": ["civil_law", "commercial_law", "government_regulations", "administrative_law"],
    "medical": ["healthcare_standards", "islamic_medical_ethics", "patient_care", "medical_terminology"],
    "educational": ["curriculum_standards", "academic_requirements", "educational_policy", "student_assessment"],
    "government": ["administrative_procedures", "citizen_services", "public_policy", "regulatory_compliance"],
    "business": ["islamic_finance", "halal_business", "commercial_standards", "trade_regulations"]
}
...
class IraqiContext:
    ...
    health_status: Dict[str, Any] = field(default_factory=lambda: {
        "status": "healthy",
        "api_service": False,
    ...
    cultural_config: Dict[str, Any] = field(default_factory=lambda: {
    ...
    def update_cultural_metrics(self, 
...
class IraqiServiceClient:
    ...
    def __init__(self):
        ...
        self.cultural_service_url = os.getenv("IRAQI_CULTURAL_SERVICE_URL", f"{self.base_url}/cultural")
        self.arabic_service_url = os.getenv("IRAQI_ARABIC_SERVICE_URL", f"{self.base_url}/arabic")
        self.payment_service_url = os.getenv("IRAQI_PAYMENT_SERVICE_URL", f"{self.base_url}/payments")
    ...
    async def validate_cultural_compliance(self, content: str, domain: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "validation_details": {
                    "islamic_values_compliant": islamic_score >= ISLAMIC_COMPLIANCE_THRESHOLD,
                    "culturally_appropriate": cultural_score >= CULTURAL_COMPLIANCE_THRESHOLD,
    ...
    async def process_arabic_text(self, text: str, operation: str = "analyze") -> Dict[str, Any]:
...
async def perform_iraqi_health_checks(context: IraqiContext):
    ...
    try:
        ...
        critical_services_ready = (
            ...
            context.health_status["cultural_service"] and
            context.health_status["arabic_processor"]
        )
        
        context.health_status["status"] = "healthy" if critical_services_ready else "degraded"
...
try:
    ...
    logger.info("   Cultural Features: ✓ Islamic compliance ✓ Arabic processing ✓ Professional domains")
    ...
    logger.info("✓ FastMCP server instance created successfully with Iraqi enhancements")
...
async def iraqi_health_check(ctx: Context) -> str:
    ...
    try:
        ...
        if hasattr(context, "health_status") and context.health_status:
            ...
            cultural_metrics = context.cultural_metrics.to_dict() if hasattr(context, "cultural_metrics") else {}
            ...
            return json.dumps({
                ...
                "cultural_config": {
                    "cultural_compliance_threshold": context.cultural_config["cultural_compliance_threshold"],
                    "islamic_compliance_threshold": context.cultural_config["islamic_compliance_threshold"],
                    "arabic_rtl_accuracy_threshold": context.cultural_config["arabic_rtl_accuracy_threshold"],
                    "supported_domains": list(context.cultural_config["professional_domains"].keys()),
                    "supported_gateways": list(context.cultural_config["payment_gateways"].keys())
                },
    ...
    try:
        ...
        iraqi_session_info = {
            "cultural_intelligence": {
                "status": "active" if context and hasattr(context, "cultural_metrics") else "inactive",
        ...
        if context and hasattr(context, "startup_time"):
            iraqi_session_info["server_uptime_seconds"] = time.time() - context.startup_time
...
def main():
    ...
    try:
        ...
        logger.info("   Features: ✓ Arabic Processing ✓ Cultural Compliance ✓ Islamic Values ✓ Professional Domains")
