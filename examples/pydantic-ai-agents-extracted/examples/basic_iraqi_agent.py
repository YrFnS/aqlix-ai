...
async def basic_iraqi_agent_example():
    ...
    try:
        ...
        print(f"Professional Relevance: {legal_result.cultural_validation.professional_relevance:.3f}")
        print(f"Text Direction: {legal_result.metadata.get('text_direction', 'unknown')}")
...
async def tool_integration_example():
    ...
    try:
        ...
        print(f"Dialect Confidence: {arabic_result.data.get('dialect_confidence', 0):.3f}")
        ...
        print(f"Amount: {payment_result.data.get('amount')} {payment_result.data.get('currency')}")
...
async def cultural_compliance_example():
    ...
    try:
        ...
        for i, scenario in enumerate(test_scenarios, 1):
            ...
            print(f"  Cultural Appropriateness: {result.cultural_validation.cultural_appropriateness:.3f}")
            print(f"  Islamic Compliance: {result.cultural_validation.islamic_compliance:.3f}")
            print(f"  Arabic Accuracy: {result.cultural_validation.arabic_accuracy:.3f}")
