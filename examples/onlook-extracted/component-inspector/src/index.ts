 ...
 */
export function createIraqiComponentInspector(
  options: {
...
export const DESCRIPTION =
  "Advanced component analysis engine with Iraqi cultural integration and government-grade capabilities. Built upon Onlook's proven architecture with comprehensive Arabic RTL support, Islamic compliance validation, and ministry-specific requirements.";
