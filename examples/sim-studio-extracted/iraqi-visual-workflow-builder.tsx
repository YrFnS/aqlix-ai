 ...
 */
export const IraqiWorkflowBlockDefinitions: Record<
  IraqiWorkflowBlockType,
  {
    label: string;
    labelArabic: string;
    description: string;
...
> = {
  [IraqiWorkflowBlockType.AGENT]: {
    ...
    professionalDomains: [
      IraqiProfessionalDomain.GENERAL,
  ...
  [IraqiWorkflowBlockType.IRAQI_PAYMENT]: {
    ...
    descriptionArabic:
      "معالجة المدفوعات عبر البوابات العراقية (زين كاش، فاست باي)",
    icon: "💳",
    category: "Payment",
    culturallyEnhanced: true,
    islamicCompliance: true,
    professionalDomains: [
      IraqiProfessionalDomain.BUSINESS,
      IraqiProfessionalDomain.FINANCE,
    ],
  },
  ...
  [IraqiWorkflowBlockType.API]: {
    label: "API Call",
    labelArabic: "استدعاء API",
    description: "Make HTTP API requests",
    descriptionArabic: "إجراء طلبات API HTTP",
    icon: "🌐",
  ...
  [IraqiWorkflowBlockType.CONDITION]: {
    ...
    descriptionArabic: "تفرع المنطق الشرطي",
    icon: "🔀",
    category: "Logic",
    culturallyEnhanced: false,
    islamicCompliance: false,
    professionalDomains: Object.values(IraqiProfessionalDomain),
  },
  [IraqiWorkflowBlockType.PARALLEL]: {
    ...
    descriptionArabic: "تنفيذ فروع متعددة بالتوازي",
    icon: "⚡",
    category: "Control",
    culturallyEnhanced: false,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.LOOP]: {
    ...
    descriptionArabic: "التكرار عبر البيانات أو الشروط",
    icon: "🔄",
    category: "Control",
    culturallyEnhanced: false,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.RESPONSE]: {
    ...
    descriptionArabic: "تنسيق مخرجات سير العمل",
    icon: "📤",
    category: "Output",
    culturallyEnhanced: true,
    islamicCompliance: true,
  ...
  [IraqiWorkflowBlockType.EVALUATOR]: {
    label: "Evaluator",
    labelArabic: "مقيّم",
    description: "Evaluate results and quality",
    descriptionArabic: "تقييم النتائج والجودة",
    icon: "⭐",
    category: "Analysis",
    culturallyEnhanced: true,
    islamicCompliance: true,
  ...
  [IraqiWorkflowBlockType.FUNCTION]: {
    ...
    descriptionArabic: "تنفيذ دالة JavaScript مخصصة",
    icon: "⚙️",
    category: "Custom",
    culturallyEnhanced: false,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.ROUTER]: {
    ...
    descriptionArabic: "التوجيه بناءً على الشروط",
    icon: "🛤️",
    category: "Logic",
    culturallyEnhanced: false,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.SUB_WORKFLOW]: {
    label: "Sub-Workflow",
    labelArabic: "سير عمل فرعي",
    description: "Execute nested workflow",
    descriptionArabic: "تنفيذ سير عمل متداخل",
    icon: "🔗",
    category: "Workflow",
    culturallyEnhanced: true,
    islamicCompliance: true,
  ...
  [IraqiWorkflowBlockType.DIALECT_PROCESSOR]: {
    label: "Dialect Processor",
    labelArabic: "معالج اللهجة",
    description: "Process Iraqi dialect text",
    descriptionArabic: "معالجة نص اللهجة العراقية",
    icon: "🗣️",
    category: "Arabic",
    culturallyEnhanced: true,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.RTL_FORMATTER]: {
    label: "RTL Formatter",
    labelArabic: "منسق RTL",
    description: "Format text for right-to-left display",
    descriptionArabic: "تنسيق النص للعرض من اليمين لليسار",
    icon: "↩️",
    category: "Formatting",
    culturallyEnhanced: true,
    islamicCompliance: false,
  ...
  [IraqiWorkflowBlockType.PROFESSIONAL_TEMPLATE]: {
    ...
    labelArabic: "قالب مهني",
    description: "Apply Iraqi professional document templates",
    descriptionArabic: "تطبيق قوالب المستندات المهنية العراقية",
    icon: "📋",
    category: "Templates",
    culturallyEnhanced: true,
    islamicCompliance: true,
...
const IraqiWorkflowBlock: React.FC<{
  ...
  const getStatusColor = (status: WorkflowExecutionStatus) => {
    switch (status) {
      ...
      case WorkflowExecutionStatus.PAUSED_FOR_PRAYER:
        return "text-purple-600 border-purple-200 bg-purple-50";
      case WorkflowExecutionStatus.CULTURALLY_BLOCKED:
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle className="text-sm font-medium">
                {data.culturalContext.language === "arabic"
                  ? blockDef.labelArabic
                  : blockDef.label}
              </CardTitle>
              <p className="text-xs text-gray-500 mt-1">
                {data.culturalContext.language === "arabic"
                  ? blockDef.descriptionArabic
          ...
          <div className="flex items-center space-x-1">
            ...
            {blockDef.islamicCompliance && (
              <span className="text-green-600">☪️</span>
            )}
            {blockDef.culturallyEnhanced && (
        ...
        {data.metrics.executionCount > 0 && (
          <div className="text-xs text-gray-500 space-y-1">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {Math.round(data.metrics.culturalComplianceRate * 100)}%
              </span>
            </div>
            <div className="flex justify-between">
...
const IraqiWorkflowBlockPalette: React.FC<{
  ...
  return (
    <Card className="w-80 h-full overflow-auto">
      <CardHeader>
        <CardTitle
          className={culturalContext.rtlLayout ? "text-right" : "text-left"}
        >
      ...
      <CardContent>
        <Tabs
          defaultValue={Object.keys(blockCategories)[0]}
...
export const IraqiVisualWorkflowBuilder: React.FC<{
  ...
  const onDragStart = useCallback(
    (event: React.DragEvent, blockType: IraqiWorkflowBlockType) => {
              ...
              n.id === node.id
                ? {
                    ...
                    data: {
                      ...n.data,
                      executionStatus:
                        WorkflowExecutionStatus.CULTURALLY_BLOCKED,
                    },
                  }
                : n,
            ),
              ...
              ? {
                  ...
                  data: {
                    ...
                    metrics: {
                      ...
                      successRate:
                        (n.data.metrics.successRate + 1) /
                        (n.data.metrics.executionCount + 1),
                    },
                  },
                }
              : n,
  ...
  const validateNodeCulturally = async (
    node: IraqiWorkflowNode,
    ...
    if (node.data.islamicCompliance.level === IslamicComplianceLevel.STRICT) {
      if (
        node.data.type === IraqiWorkflowBlockType.API &&
        !node.data.config.islamicCompliance
      ) {
        violations.push(
          "API calls require Islamic compliance validation in strict mode",
        );
      }
    }
    ...
    if (
      node.data.culturalContext.culturalSensitivity > 0.8 &&
      !node.data.config.culturalValidation
    ) {
              ...
              <Card className="w-64">
                ...
                <CardContent className="text-xs space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {culturalContext.prayerTimeAware ? "Yes" : "No"}
                    </span>
                  </div>
                </CardContent>
              </Card>
 ...
 */
export default function IraqiVisualWorkflowBuilderWrapper(
  props: Parameters<typeof IraqiVisualWorkflowBuilder>[0],
) {
  return (
    <ReactFlowProvider>
