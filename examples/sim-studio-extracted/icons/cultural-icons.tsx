...
export function PaymentGatewayIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <text x="18" y="16" fontSize="8" textAnchor="middle" fill="currentColor">
        IQD
      </text>
    </svg>
  )
...
export function ProfessionalDomainIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M6 9h12" strokeWidth="1" opacity="0.5" />
...
export function RTLLayoutIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M9 12h11" />
      <path d="M9 18h11" />
      <path d="M5 6v12" strokeWidth="3" opacity="0.5" />
      <path d="M21 4l-2 2 2 2" />
