/**
 * Iraqi AI Enhanced Workflow Icons
 * SVG icons for visual workflow builder with cultural context
 */
...
export function WorkflowIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M6 9v3a3 3 0 0 0 3 3h2" />
      <path d="M18 9v3a3 3 0 0 1-3 3h-2" />
    </svg>
  )
}

export function ConditionIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function ResponseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M10 9.5a.5.5 0 0 1 0 1" />
      <path d="M14 9.5a.5.5 0 0 1 0 1" />
    </svg>
  )
}
...
export function SlackIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <rect x="15" y="8" width="6" height="3" rx="1" />
      <rect x="8" y="3" width="3" height="6" rx="1" />
      <rect x="8" y="15" width="3" height="6" rx="1" />
    </svg>
  )
}