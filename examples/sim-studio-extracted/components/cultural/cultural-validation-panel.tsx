...
export function CulturalValidationPanel({
  ...
  const getOverallStatus = () => {
    if (!validationResult)
      return { status: "pending", color: "text-gray-500", icon: Shield };

    if (
      validationResult.confidence >= 0.95 &&
      validationResult.islamicCompliance >= 0.9
    ) {
      return {
        status: "excellent",
  ...
  const getViolationTypeLabel = (type: string) => {
    switch (type) {
      case "islamic":
        return "إسلامي / Islamic";
      case "political":
        return "سياسي / Political";
      case "professional":
        return "مهني / Professional";
      case "cultural":
        return "ثقافي / Cultural";
      default:
        return type;
    }
  };
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span>
                    {Math.round(validationResult.islamicCompliance * 100)}%
                  </span>
                </div>
                <Progress
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span>
                    {Math.round(validationResult.politicalNeutrality * 100)}%
                  </span>
                </div>
                <Progress
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span>
                    {Math.round(validationResult.professionalAppropriate * 100)}
                    %
                  </span>
                </div>
                <Progress
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <Badge
                            className={cn(
                              "text-xs text-white",
                              getViolationColor(violation.severity),
                            )}
                          >
              ...
              <div className="pt-4 border-t">
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <span className="ml-2">
                      {validationResult.detailedReport.processingTime}ms
                    </span>
                  </div>
