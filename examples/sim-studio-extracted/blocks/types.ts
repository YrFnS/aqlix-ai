...
export type ParamType = 'string' | 'number' | 'boolean' | 'json' | 'arabic-text' | 'professional-domain'
export type PrimitiveValueType = 'string' | 'number' | 'boolean' | 'json' | 'array' | 'any' | 'arabic-text'

export type BlockCategory = 'blocks' | 'tools' | 'triggers' | 'iraqi-cultural' | 'professional-domains'
