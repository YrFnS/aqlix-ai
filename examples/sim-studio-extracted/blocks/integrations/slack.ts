...
export const SlackBlock: BlockConfig<IraqiSlackResponse> = {
  ...
  longDescription: 'Enhanced Slack integration with Arabic message support, cultural validation, and professional domain compliance for Iraqi teams',
  ...
  subBlocks: [
...

    {
      ...
      mode: 'advanced',
      description: 'Validate message content for Iraqi cultural appropriateness',
      culturalValidation: {
        enabled: true,
...

    {
      ...
      options: [
        ...
        { label: 'تصحيح النصوص العربية / Correct Arabic text', id: 'arabic-correction' },
        { label: 'تحويل اللهجة / Convert dialect', id: 'dialect-conversion' },
        { label: 'إضافة رموز تعبيرية عربية / Add Arabic emojis', id: 'arabic-emojis' },
      ],
      rtlSupport: true,
    },
