...
export const ApiBlock: BlockConfig<IraqiApiResponse> = {
  ...
  longDescription: 'Enhanced API integration with Iraqi cultural intelligence, Arabic content processing, and security validation for professional domains',
  ...
  subBlocks: [
...

    {
      ...
      mode: 'advanced',
      description: 'Validate API request/response for Iraqi cultural appropriateness',
      culturalValidation: {
        enabled: true,
...

    {
      ...
      mode: 'advanced',
      options: [
        { label: 'معالجة النصوص الواردة / Process incoming Arabic text', id: 'process-incoming' },
...

    {
      ...
      mode: 'advanced',
      options: [
        { label: 'فحص الروابط المشبوهة / Scan for suspicious URLs', id: 'url-scanning' },
        { label: 'التحقق من الشهادات / Certificate validation', id: 'cert-validation' },
...

    {
      ...
      mode: 'advanced',
      options: [
        { label: 'إعادة المحاولة التلقائية / Auto retry on failure', id: 'auto-retry' },
        { label: 'تأخير تدريجي / Exponential backoff', id: 'exponential-backoff' },
        { label: 'إعادة المحاولة للأخطاء المؤقتة / Retry on temporary errors', id: 'retry-temp-errors' },
      ],
      rtlSupport: true,
    },
  ],
