...
export const LegalDocumentBlock: BlockConfig<LegalDocumentResponse> = {
  ...
  longDescription:
    "Comprehensive Iraqi legal document processing with Islamic law compliance, Arabic legal terminology validation, and Iraqi legal system integration",
  ...
  subBlocks: [
...

    {
      ...
      description:
        "Legal document content in Arabic with legal terminology support",
      rtlSupport: true,
      arabicKeyboard: true,
...

    {
      ...
      layout: "full",
      description:
        "Ensure document complies with Islamic legal principles (Sharia)",
      mode: "advanced",
    },

    {
      ...
      options: [
        {
          label: "القانون المدني العراقي / Iraqi Civil Code",
          id: "civil-code",
        },
        {
          label: "قانون الأحوال الشخصية / Personal Status Law",
          id: "personal-status",
        },
...

    {
      ...
      options: [
        {
          label: "عربية فصحى قانونية / Classical Legal Arabic",
          id: "classical",
        },
