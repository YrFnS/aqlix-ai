...
export const ArabicTextProcessorBlock: BlockConfig = {
  ...
  longDescription:
    "Comprehensive Arabic text processing including RTL layout, Iraqi dialect recognition, and mixed Arabic-English content handling",
  ...
  subBlocks: [
...

    {
      ...
      options: [
        {
          label: "نص عربي وإنجليزي / Arabic-English Text",
          id: "arabic-english",
        },
