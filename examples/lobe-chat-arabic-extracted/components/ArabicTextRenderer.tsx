    ...
    return (
      ...
      >
        ...
        {performanceMonitoring && metrics && (
          <div
            className="arabic-performance-indicator"
            style={{
              position: 'absolute',
              top: '-20px',
              right: '0',
          ...
          >
            {metrics.renderTime.toFixed(1)}ms | {metrics.detectedLanguage} |{' '}
            {metrics.detectedDialect}
          </div>
        )}
      </div>
    );
...
export const ArabicChatMessage = forwardRef<
  ArabicTextRendererRef,
...
export const ArabicProfessionalText = forwardRef<
  ArabicTextRendererRef,
...
export const ArabicLegalText = forwardRef<
  ArabicTextRendererRef,
...
export const ArabicMedicalText = forwardRef<
  ArabicTextRendererRef,
...
export const ArabicEducationalText = forwardRef<
  ArabicTextRendererRef,
  Omit<ArabicTextRendererProps, 'domain'>
>(({ children, ...props }, ref) => (
  <ArabicTextRenderer
...
export const ArabicTechnicalText = forwardRef<
  ArabicTextRendererRef,
  Omit<ArabicTextRendererProps, 'domain'>
>(({ children, ...props }, ref) => (
  <ArabicTextRenderer
