...
class LLMProvider(ABC):
    ...
    async def generate_streaming_response(self, 
                                        messages: List[LLMMessage]) -> AsyncGenerator[str, None]:
        """Generate streaming response from LLM"""
        pass
    
    async def chat(self, message: str, 
                   system_prompt: Optional[str] = None,
                   cultural_context: Optional[str] = None) -> LLMResponse:
    ...
    async def analyze_webpage(self, page_content: str, 
...
"""
    ...
    async def generate_form_strategy(self, form_analysis: Dict[str, Any]) -> LLMResponse:
...
"""
    ...
    async def translate_content(self, content: str, 
                              target_language: str = "ar") -> LLMResponse:
...
"""
    ...
    def get_conversation_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "model": self.config.model_name,
            "arabic_messages": sum(1 for msg in self.conversation_history 
