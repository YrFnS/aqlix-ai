...
class IraqiRAGService:
    ...
    async def search_documents(
        ...
        try:
            ...
            logger.info(f"Iraqi document search - Query: '{query[:50]}...', "
            ...
            logger.info(f"Iraqi document search completed - {len(results)} results, "
    ...
    async def search_code_examples(
        ...
        try:
            ...
            logger.info(f"Iraqi code search - Query: '{query[:50]}...', "
            ...
            logger.info(f"Iraqi code search completed - {len(results)} enhanced code examples")
    ...
    async def perform_rag_query(
        ...
        try:
            ...
            logger.info(f"Iraqi RAG query - Query: '{query[:50]}...', "
            ...
            for i, result in enumerate(search_results):
                try:
                    formatted_result = await self._format_iraqi_rag_result(result, iraqi_context)
            ...
            response_data = {
                ...
                "search_mode": "hybrid" if self.config.enable_hybrid_search else "vector",
                ...
                "performance_metrics": {
                    ...
                    "cultural_validations_performed": len([r for r in formatted_results if "cultural_validation" in r]),
                    "arabic_processing_applied": len([r for r in formatted_results if "arabic_processing" in r]),
                    "average_cultural_score": self._calculate_average_cultural_score(formatted_results)
                }
            }
            ...
            logger.info(f"Iraqi RAG query completed - {len(formatted_results)} results, "
                       f"Time: {processing_time:.2f}s")
            ...
            return False, {
                ...
                "source": source,
                "execution_path": "iraqi_rag_service_pipeline",
                "iraqi_context_attempted": iraqi_context.__dict__ if iraqi_context else None
            }
    ...
    async def search_code_examples_service(
        ...
        try:
            ...
            logger.info(f"Iraqi code service search - Query: '{query[:50]}...', "
                       f"Source: {source_id}, Domain: {iraqi_context.professional_domain}")
            ...
            success, agentic_result = await self.agentic_strategy.perform_agentic_search(
                query=query,
                source_id=source_id,
                match_count=match_count,
            ...
            if self.reranking_strategy and results:
                try:
                    ...
                    agentic_result["reranking_metadata"] = reranking_result.performance_metrics
            ...
            logger.info(f"Iraqi code service completed - {len(results)} enhanced code examples")
    ...
    async def _format_iraqi_rag_result(
        ...
        formatted_result = {
            ...
            "iraqi_relevance_score": result.get("iraqi_relevance_score", result.get("similarity", 0.0))
        }
    ...
    def get_service_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_stats": {
                ...
                "hybrid_strategy": self.hybrid_strategy.get_search_performance_metrics() if hasattr(self.hybrid_strategy, 'get_search_performance_metrics') else {},
                "reranking_strategy": self.reranking_strategy.get_reranking_statistics() if self.reranking_strategy else {},
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health_status["components"]["supabase_client"] = "connected" if self.supabase_client else "disconnected"
            ...
            health_status["components"]["reranking_strategy"] = "loaded" if self.reranking_strategy else "disabled"
            health_status["components"]["agentic_strategy"] = "loaded" if self.agentic_strategy.is_enabled() else "disabled"
    ...
    @classmethod
    def create_from_config(cls, config_dict: Dict[str, Any], supabase_client=None) -> "IraqiRAGService":
