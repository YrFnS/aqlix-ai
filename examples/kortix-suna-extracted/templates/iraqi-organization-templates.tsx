...
import { Users, Building, Briefcase, GraduationCap, Shield, Phone, Mail, MapPin } from 'lucide-react';
    ...
    roles: [
      {
        ...
        permissions: ['full_access', 'client_management', 'case_approval', 'billing_approval'],
        level: 'senior'
      },
      {
        title: 'Associate Lawyer',
        titleArabic: 'محامي مشارك',
        permissions: ['case_management', 'client_communication', 'document_preparation'],
        level: 'mid'
      },
      {
        title: 'Legal Assistant',
        titleArabic: 'مساعد قانوني',
        permissions: ['document_processing', 'appointment_scheduling', 'research'],
        level: 'support'
      }
    ]
  },
    ...
    roles: [
      {
        ...
        permissions: ['full_access', 'patient_care', 'staff_management', 'billing_oversight'],
        level: 'senior'
      },
      {
      ...
      },
      {
        ...
        permissions: ['patient_care', 'medication_administration', 'vital_monitoring'],
        level: 'support'
      },
      {
        title: 'Medical Assistant',
        titleArabic: 'مساعد طبي',
        permissions: ['appointment_scheduling', 'patient_records', 'administrative_tasks'],
        level: 'support'
      }
    ]
  },
    ...
    roles: [
      {
        title: 'Dean',
        titleArabic: 'عميد',
        permissions: ['full_access', 'academic_oversight', 'budget_management', 'staff_hiring'],
        level: 'senior'
      },
      {
        title: 'Professor',
        titleArabic: 'أستاذ',
        permissions: ['course_management', 'student_evaluation', 'research_supervision'],
        level: 'senior'
      },
      {
    ...
    roles: [
      {
        title: 'Minister',
        titleArabic: 'وزير',
        permissions: ['full_access', 'policy_making', 'budget_approval', 'strategic_planning'],
        level: 'senior'
      },
      {
        title: 'Director General',
        titleArabic: 'مدير عام',
        permissions: ['department_management', 'staff_oversight', 'project_approval'],
        level: 'senior'
      },
      {
      ...
      },
      {
        ...
        permissions: ['service_delivery', 'document_processing', 'citizen_support'],
        level: 'support'
      }
    ]
  },
  workflows: [
    {
      ...
      description: 'Processing citizen service requests through digital platforms',
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>{template.teamStructure.partners + template.teamStructure.associates + template.teamStructure.support_staff} team members</span>
              </div>
