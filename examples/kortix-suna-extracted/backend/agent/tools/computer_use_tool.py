...
class ComputerUseTool(SandboxToolsBase):
    ...
    async def _ensure_api_url(self):
        ...
        if not self._url_initialized:
            ...
            self.api_base_url = (
                preview_link.url if hasattr(preview_link, "url") else str(preview_link)
            )
            self._url_initialized = True
            logging.info(
                f"Initialized Computer Use Tool with API URL: {self.api_base_url}"
            )
    ...
    async def move_to(self, x: float, y: float) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to move: {result.get('error', 'Unknown error')}",
                )
    ...
    async def click(
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to click: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def scroll(self, amount: int) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to scroll: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def typing(self, text: str) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to type: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def press(self, key: str) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to press key: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def mouse_down(
        self, button: str = "left", x: Optional[float] = None, y: Optional[float] = None
    ) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to press button: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def mouse_up(
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to release button: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
            return ToolResult(
                success=False, output=f"Failed to release button: {str(e)}"
            )
    ...
    async def drag_to(self, x: float, y: float) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                return ToolResult(
                    success=False,
                    output=f"Failed to drag: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
    ...
    async def hotkey(self, keys: str) -> ToolResult:
        ...
        try:
            ...
            if result.get("success", False):
                return ToolResult(
                    success=True, output=f"Pressed key combination: {keys}"
                )
            else:
                return ToolResult(
                    success=False,
                    output=f"Failed to press keys: {result.get('error', 'Unknown error')}",
                )
        except Exception as e:
