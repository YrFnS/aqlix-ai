          ...
          <ThreadContent
            ...
            emptyStateComponent={
              <div className="flex flex-col items-center text-center text-muted-foreground/80">
                ...
                <p className="w-[70%] text-sm text-muted-foreground/60">
                  Test your agent's configuration and chat back and forth to see
                  how it performs with your current settings, tools, and
                  knowledge base.
                </p>
              </div>
            }
      ...
      <div className="flex-shrink-0">
        <div className="p-0 md:p-4 md:px-10">
          <ChatInput
            ...
            onAgentSelect={() => {
              toast.info(
                "You can only test the agent you are currently configuring",
              );
            }}
          />
        </div>
