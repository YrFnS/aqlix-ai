...
export function ConfigurationTab({
  ...
  const isSystemPromptEditable =
    !isViewingOldVersion && restrictions.system_prompt_editable !== false;
  const areToolsEditable =
    !isViewingOldVersion && restrictions.tools_editable !== false;

  const handleSystemPromptChange = (value: string) => {
    console.log("📝 System prompt change in ConfigurationTab:", {
      value,
      length: value.length,
      hasImmediateSave: !!onSystemPromptSave,
    });
  ...
  const handleToolsChange = (
    ...
    console.log("🔧 Tools change in ConfigurationTab:", {
      tools,
      toolsCount: Object.keys(tools).length,
      hasImmediateSave: !!onToolsSave,
    });
        ...
        {isSunaAgent && (
          <div className="mb-4 p-4 bg-primary/10 border border-primary-200 rounded-xl">
            ...
            <p className="text-sm text-primary-700">
              This is Suna's default agent with centrally managed system prompt
              and tools. You can customize integrations, knowledge base,
              workflows, and triggers to personalize your experience.
            </p>
          </div>
        )}
        ...
        <div className="space-y-3">
          {!isSunaAgent && (
            <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
              <button
                ...
                onClick={() =>
                  setOpenAccordion(openAccordion === "system" ? "" : "system")
                }
              >
                <div className="flex items-center gap-4 w-full">
                  ...
                  <div className="text-left flex-1">
                    <h4 className="font-semibold text-base text-foreground mb-1 group-hover:text-primary transition-colors duration-300">
                      System Prompt
                    </h4>
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "system" ? "rotate-180" : ""}`}
                  />
                </div>
              </button>
              <div
          ...
          {!isSunaAgent && (
            <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
              <button
                className="w-full p-4 text-left group-hover:bg-muted/30 transition-all duration-300"
                onClick={() =>
                  setOpenAccordion(openAccordion === "tools" ? "" : "tools")
                }
              >
                <div className="flex items-center gap-4 w-full">
                  <div className="relative">
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "tools" ? "rotate-180" : ""}`}
                  />
                </div>
              </button>
              <div
                ...
                <div className="px-6 pb-6 pt-2">
                  <div className="border-t border-border/30 pt-4">
                    <AgentToolsConfiguration
                      ...
                      onToolsChange={
                        areToolsEditable ? handleToolsChange : () => {}
                      }
          ...
          <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
            <button
              ...
              onClick={() =>
                setOpenAccordion(
                  openAccordion === "integrations" ? "" : "integrations",
                )
              }
            >
              <div className="flex items-center gap-4 w-full">
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "integrations" ? "rotate-180" : ""}`}
                />
              </div>
            </button>
            <div
          ...
          <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
            <button
              ...
              onClick={() =>
                setOpenAccordion(
                  openAccordion === "knowledge" ? "" : "knowledge",
                )
              }
            >
              <div className="flex items-center gap-4 w-full">
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "knowledge" ? "rotate-180" : ""}`}
                />
              </div>
            </button>
            <div
          ...
          <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
            <button
              ...
              onClick={() =>
                setOpenAccordion(
                  openAccordion === "workflows" ? "" : "workflows",
                )
              }
            >
              <div className="flex items-center gap-4 w-full">
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "workflows" ? "rotate-180" : ""}`}
                />
              </div>
            </button>
            <div
          ...
          <div className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30">
            ...
            >
              <div className="flex items-center gap-4 w-full">
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform duration-300 ease-out ${openAccordion === "triggers" ? "rotate-180" : ""}`}
                />
              </div>
            </button>
            <div
