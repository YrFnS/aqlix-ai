...
import { Plus, Loader2, Shield, Settings } from "lucide-react";
...
export const ProfileConnector: React.FC<ProfileConnectorProps> = ({
  ...
  const hasConnectedPipedreamProfile =
    pipedreamProfiles?.some((p) => p.is_connected) || false;
  ...
  const handleCreateProfile = useCallback(async () => {
    ...
    try {
      ...
      onProfileSelect(
        step.qualified_name,
        response.profile_id || "new-profile",
      );
      setProfileStep("select");
      setNewProfileName("");
      setConfig({});
            ...
            {hasConnectedPipedreamProfile ? (
              ...
              <div className="space-y-4">
                <Alert className="border-primary/20 bg-primary/5">
                  ...
                  <AlertDescription>
                    No connected {step.service_name} profiles found. Create and
