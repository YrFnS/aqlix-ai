      ...
      <CardContent className="space-y-4">
        ...
        {commitmentInfo?.has_commitment && (
          <>
            ...
            {commitmentInfo.months_remaining !== undefined &&
              commitmentInfo.months_remaining > 0 && (
                <div className="flex items-center justify-between">
        ...
        {hasCommitment &&
          !commitmentInfo?.can_cancel &&
          !isAlreadyCancelled && (
            <Alert className="border-blue-200 bg-blue-50">
              <Shield className="h-4 w-4 text-blue-600" />
              <AlertDescription className="text-sm text-blue-800">
                Your subscription cannot be cancelled during the commitment
                period, but you can schedule it to end when your commitment
                expires. You can upgrade to a higher plan at any time.
              </AlertDescription>
            </Alert>
          )}
            ...
            <AlertDescription className="text-sm">
              {subscription.cancel_at ? (
                <>
                  ...
                  {getEffectiveCancellationDate()} (end of commitment period).
                  You'll continue to have access until then.
                </>
              ) : (
                <>
                  Your subscription will end on {getEffectiveCancellationDate()}
                  . You'll continue to have access until then.
                </>
              )}
            </AlertDescription>
              ...
              <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-sm leading-relaxed">
                    {hasCommitment ? (
                      <>
                        Are you sure you want to schedule your subscription for
                        cancellation? Since you have a yearly commitment, your
                        subscription will be scheduled to end on{" "}
                        {commitmentInfo?.commitment_end_date
                          ? formatEndDate(commitmentInfo.commitment_end_date)
                          : "your commitment end date"}
