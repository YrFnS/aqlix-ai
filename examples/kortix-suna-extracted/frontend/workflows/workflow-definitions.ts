...
export const TOOL_COLORS: Record<string, string> = {
  sb_files_tool:
    "from-blue-500/20 to-blue-600/10 border-blue-500/20 text-blue-500",
  sb_shell_tool:
    "from-purple-500/20 to-purple-600/10 border-purple-500/20 text-purple-500",
  sb_deploy_tool:
    "from-orange-500/20 to-orange-600/10 border-orange-500/20 text-orange-500",
  sb_expose_tool:
    "from-green-500/20 to-green-600/10 border-green-500/20 text-green-500",
  sb_vision_tool:
    "from-blue-500/20 to-blue-600/10 border-blue-500/20 text-blue-500",
  sb_browser_tool:
    "from-purple-500/20 to-purple-600/10 border-purple-500/20 text-purple-500",
...
export const BASE_STEP_DEFINITIONS: StepDefinition[] = [
  ...
  },
  {
    ...
    color:
      "from-indigo-500/20 to-indigo-600/10 border-indigo-500/20 text-indigo-500",
  ...
  },
  {
    ...
    category: "configuration",
    color:
      "from-emerald-500/20 to-emerald-600/10 border-emerald-500/20 text-emerald-500",
...
export function getStepIconAndColor(stepType: any): {
  icon: any;
  color: string;
} {
