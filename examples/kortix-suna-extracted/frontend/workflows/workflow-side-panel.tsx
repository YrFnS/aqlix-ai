...
export function WorkflowSidePanel({
  ...
  const filteredStepTypes = availableStepTypes.filter(
    (type) =>
  ...
  const handlePipedreamToolsSelected = async (
    profileId: string,
    ...
    try {
      ...
      const nonPipedreamMCPs = existingCustomMCPs.filter(
        (mcp: any) =>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div
                            className={`relative p-2 rounded-lg bg-gradient-to-br ${color} border`}
                          >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onUpdateStep({ id: selectedStep.id, name: e.target.value })
                  }
            ...
            <div className="pt-4 border-t border-zinc-200 dark:border-zinc-700">
              ...
              >
                ...
                {selectedStep.conditions?.type === "if"
                  ? "Delete Conditional Group"
                  : "Delete Step"}
              </Button>
            </div>
          </div>
  ...
  return (
    <>
      ...
      <Dialog
        open={showPipedreamRegistry}
        onOpenChange={setShowPipedreamRegistry}
      >
