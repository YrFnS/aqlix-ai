...
export default function MCPConfigurationDialog({
  ...
  const handleRemoveConfiguration = (id: string) => {
    ...
    if (config) {
      ...
      const { [config.qualifiedName]: removed, ...remainingMappings } =
        profileMappings;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[85vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up Model Context Protocol servers for your workflow using
            credential profiles
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="configure" disabled={!selectedServer}>
              Configure
            </TabsTrigger>
            <TabsTrigger value="configured">
              Configured ({configurations.length})
            </TabsTrigger>
          </TabsList>
                ...
                <div className="space-y-4">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Select or create a credential profile for this MCP
                        server
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CredentialProfileSelector
                        ...
                        selectedProfileId={
                          profileMappings[selectedServer.qualifiedName]
                        }
              ...
              {configurations.length === 0 ? (
                ...
                <div className="space-y-4 p-1">
                  {configurations.map((config) => {
                    const server = mockMCPServers.find(
                      (s) => s.id === config.id,
                    );
                    ...
                    return (
                      <Card
                        key={config.id}
                        className={!hasValidProfile ? "border-yellow-500" : ""}
                      >
                        <CardHeader>
                        ...
                        <CardContent>
                          ...
                          {!hasValidProfile && (
                            <div className="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded text-sm text-yellow-800">
                              ...
                              No credential profile selected. Please configure
                              credentials.
                            </div>
                          )}
                        </CardContent>
