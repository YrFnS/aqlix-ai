...
const defaultConfig: ImageSettingsConfig = {
  ...
  professional: {
    legal: {
      ...
      specialInstructions:
        "Legal content must comply with Iraqi law and Islamic jurisprudence",
    },
    medical: {
      enabled: true,
      requiresApproval: true,
      specialInstructions:
        "Medical content must be reviewed by qualified professionals",
    },
    educational: {
      enabled: true,
      requiresApproval: false,
      specialInstructions:
        "Educational content should support Iraqi curriculum standards",
    },
    business: {
      enabled: true,
      requiresApproval: false,
      specialInstructions:
        "Business content must respect Islamic commercial principles",
    },
    engineering: {
      enabled: true,
      requiresApproval: false,
      specialInstructions:
        "Engineering content should follow Iraqi technical standards",
    },
  },
};
...
export const ImageSettings: React.FC<ImageSettingsProps> = ({
  ...
  const updateSettings = useCallback(
    (section: keyof ImageSettingsConfig, field: string, value: any) => {
      setSettings((prev) => ({
        ...prev,
        [section]: {
          ...prev[section],
  ...
  const updateProfessionalSettings = useCallback(
    (domain: string, field: string, value: any) => {
      setSettings((prev) => ({
        ...prev,
        professional: {
          ...prev.professional,
        ...
        <div className={`flex items-center gap-3 ${flexDir}`}>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              {isRtlMode
                ? "إعدادات إنتاج وتعديل الصور"
                : "Configure image generation and editing"}
            </p>
          </div>
        </div>
        ...
        <div className={`flex items-center gap-2 ${flexDir}`}>
          {hasUnsavedChanges && (
            <div className="flex items-center gap-1 px-2 py-1 bg-yellow-50 rounded text-xs text-yellow-700">
              ...
              <span>
                {isRtlMode ? "تغييرات غير محفوظة" : "Unsaved changes"}
              </span>
            </div>
          )}
        ...
        <div className="lg:col-span-3">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      updateSettings("openai", "apiKey", e.target.value)
                    }
                    disabled={readOnly}
                    placeholder="sk-..."
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateSettings("openai", "organization", e.target.value)
                  }
                  disabled={readOnly}
                  placeholder="org-..."
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:cursor-not-allowed ${textAlign}`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateSettings("openai", "endpoint", e.target.value)
                  }
                  disabled={readOnly}
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:cursor-not-allowed ${textAlign}`}
                />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["dall-e-2", "dall-e-3"].map((model) => (
                    <label
                      key={model}
                      className={`flex items-center gap-2 p-3 border border-gray-200 rounded-lg ${flexDir}`}
                    >
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) => {
                          const newModels = e.target.checked
                            ...
                            : settings.openai.enabledModels.filter(
                                (m) => m !== model,
                              );
              ...
              <div>
                <label
                  className={`block text-sm font-medium text-gray-700 mb-3 ${textAlign}`}
                >
                  {isRtlMode ? "حدود المعدل" : "Rate Limits"}
                </label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(settings.openai.rateLimits).map(
                    ([model, limits]) => (
                      <div
                        key={model}
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <input
                              ...
                              value={limits.rpm}
                              onChange={(e) =>
                                updateSettings("openai", "rateLimits", {
          ...
          {activeTab === "cultural" && (
            <div className="space-y-6">
              ...
              {/* Enable Validation */}
              <div
                className={`flex items-center justify-between p-4 border border-gray-200 rounded-lg ${flexDir}`}
              >
                <div>
                  <h4 className={`font-medium ${textAlign}`}>
                    {isRtlMode
                      ? "تفعيل التحقق الثقافي"
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className={`text-sm text-gray-600 ${textAlign}`}>
                    {isRtlMode ? "القيمة الحالية" : "Current value"}:{" "}
                    {Math.round(settings.cultural.minimumCulturalScore * 100)}%
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    {isRtlMode
                      ? "المصطلحات المحظورة (عربي)"
                      : "Blocked Terms (Arabic)"}
                  </label>
                  <textarea
                    ...
                    disabled={readOnly}
                    placeholder={
                      isRtlMode ? "مصطلح واحد في كل سطر" : "One term per line"
                    }
                ...
                <div>
                  ...
                  >
                    {isRtlMode
                      ? "المصطلحات المحظورة (إنجليزي)"
                      : "Blocked Terms (English)"}
                  </label>
                  <textarea
            ...
            <div className="space-y-6">
              ...
              >
                <div>
                  <h4 className={`font-medium ${textAlign}`}>
                    {isRtlMode
                      ? "تفعيل التخطيط من اليمين لليسار"
                      : "Enable RTL Layout"}
                  </h4>
                  <p className={`text-sm text-gray-600 mt-1 ${textAlign}`}>
                    {isRtlMode
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateSettings("arabic", "defaultDialect", e.target.value)
                  }
                  disabled={readOnly}
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateSettings("arabic", "arabicFontFamily", e.target.value)
                  }
                  disabled={readOnly}
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateSettings("arabic", "textDirection", e.target.value)
                  }
                  disabled={readOnly}
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                >
                  ...
                  <option value="ltr">
                    {isRtlMode ? "من اليسار لليمين" : "Left to Right"}
                  </option>
                  <option value="rtl">
                    {isRtlMode ? "من اليمين لليسار" : "Right to Left"}
                  </option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateSettings("usage", "resetPeriod", e.target.value)
                  }
                  disabled={readOnly}
                  className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                >
                  <option value="hourly">
                    {isRtlMode ? "ساعياً" : "Hourly"}
                  </option>
                  <option value="daily">
                    {isRtlMode ? "يومياً" : "Daily"}
                  </option>
                  <option value="weekly">
                    {isRtlMode ? "أسبوعياً" : "Weekly"}
                  </option>
                  <option value="monthly">
                    {isRtlMode ? "شهرياً" : "Monthly"}
                  </option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings("quality", "defaultSize", e.target.value)
                    }
                    disabled={readOnly}
                    className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                  >
                ...
                <div>
                  ...
                  >
                    <option value="standard">
                      {isRtlMode ? "عادي" : "Standard"}
                    </option>
                    <option value="hd">
                      {isRtlMode ? "عالي الدقة" : "HD"}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings("quality", "defaultStyle", e.target.value)
                    }
                    disabled={readOnly}
                    className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                  >
                    <option value="natural">
                      {isRtlMode ? "طبيعي" : "Natural"}
                    </option>
                    <option value="vivid">
                      {isRtlMode ? "حيوي" : "Vivid"}
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  >
                    {isRtlMode
                      ? "انتهاء صلاحية التخزين المؤقت (ساعات)"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings("security", "logLevel", e.target.value)
                    }
                    disabled={readOnly}
                    className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 ${textAlign}`}
                  >
                    ...
                    <option value="warn">
                      {isRtlMode ? "تحذير" : "Warning"}
                    </option>
                    <option value="info">
                      {isRtlMode ? "معلومات" : "Info"}
                    </option>
                    <option value="debug">
                      {isRtlMode ? "تصحيح" : "Debug"}
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {[
                    ...
                    <label
                      key={type}
                      className={`flex items-center gap-2 p-2 border border-gray-200 rounded ${flexDir}`}
                    >
                      <input
                        type="checkbox"
                        checked={settings.security.allowedFileTypes.includes(
                          type,
                        )}
                        onChange={(e) => {
                          const newTypes = e.target.checked
                            ? [...settings.security.allowedFileTypes, type]
                            : settings.security.allowedFileTypes.filter(
                                (t) => t !== type,
                              );
                          updateSettings(
                            "security",
                ...
                {professionalDomains.map((domain) => {
                  ...
                  const domainSettings =
                    settings.professional[
                      domain.key as keyof typeof settings.professional
                    ];
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex items-center gap-3 mb-4 ${flexDir}`}
                      >
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          <span
                            className={`text-sm text-gray-700 ${textAlign}`}
                          >
                            {isRtlMode
                              ? "تفعيل هذا المجال"
                              : "Enable this domain"}
