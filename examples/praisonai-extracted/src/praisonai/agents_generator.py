...
class IraqiAgentGenerator:
    ...
    def _load_legal_templates(self) -> Dict[str, Any]:
        ...
        return {
            "civil_law_specialist": {
                ...
                "tools": ["iraqi_law_database", "sharia_compliance_checker", "legal_document_generator"],
                "cultural_requirements": ["islamic_compliance", "iraqi_legal_tradition"],
                "language_support": ["iraqi_arabic", "formal_arabic", "legal_terminology"]
            },
            "sharia_compliance_advisor": {
                ...
                "tools": ["sharia_law_database", "islamic_ruling_search", "compliance_validator"],
                "cultural_requirements": ["strict_islamic_adherence", "scholarly_methodology"],
                "language_support": ["quranic_arabic", "iraqi_arabic", "islamic_legal_terms"]
            },
            "contract_specialist": {
                ...
                "tools": ["contract_templates", "islamic_finance_checker", "iraqi_commercial_law"],
                "cultural_requirements": ["islamic_commercial_law", "iraqi_business_customs"],
                "language_support": ["business_arabic", "legal_arabic", "contract_terminology"]
            }
        }
    ...
    def _load_medical_templates(self) -> Dict[str, Any]:
        ...
        return {
            "medical_consultation_advisor": {
                ...
                "tools": ["medical_database_iraq", "islamic_medical_ethics", "patient_privacy_protector"],
                "cultural_requirements": ["islamic_medical_ethics", "patient_dignity", "gender_appropriate_care"],
                "language_support": ["medical_arabic", "iraqi_dialect_medical", "formal_arabic"]
            },
            "healthcare_navigator": {
                ...
                "tools": ["hospital_directory_iraq", "insurance_checker", "appointment_scheduler"],
                "cultural_requirements": ["respectful_communication", "family_centered_care"],
                "language_support": ["iraqi_arabic", "medical_terminology", "patient_communication"]
            }
        }
    ...
    def _load_educational_templates(self) -> Dict[str, Any]:
        ...
        return {
            "curriculum_advisor": {
                ...
                "tools": ["iraqi_curriculum_database", "islamic_studies_materials", "arabic_language_resources"],
                "cultural_requirements": ["islamic_educational_values", "arabic_language_priority"],
                "language_support": ["educational_arabic", "iraqi_dialect", "classical_arabic"]
            },
            "arabic_language_tutor": {
                ...
                "tools": ["arabic_grammar_checker", "iraqi_dialect_dictionary", "pronunciation_guide"],
    ...
    def _load_government_templates(self) -> Dict[str, Any]:
        ...
        return {
            "citizen_services_advisor": {
                ...
                "tools": ["government_procedures_database", "document_requirements_checker", "service_locator"],
                "cultural_requirements": ["respectful_government_interaction", "citizen_dignity"],
                "language_support": ["official_arabic", "iraqi_arabic", "government_terminology"]
            },
            "document_processing_assistant": {
                ...
                "tools": ["document_templates", "requirement_checker", "submission_tracker"],
    ...
    def _load_business_templates(self) -> Dict[str, Any]:
        ...
        return {
            "business_consultant": {
                ...
                "tools": ["market_analysis_iraq", "islamic_finance_calculator", "business_registration_guide"],
                "cultural_requirements": ["islamic_business_ethics", "local_market_knowledge"],
                "language_support": ["business_arabic", "iraqi_dialect", "financial_terminology"]
            },
            "islamic_finance_advisor": {
                ...
                "tools": ["sharia_compliance_checker", "islamic_banking_products", "halal_investment_analyzer"],
                "cultural_requirements": ["strict_sharia_compliance", "riba_avoidance"],
                "language_support": ["islamic_finance_arabic", "iraqi_arabic", "banking_terminology"]
            }
        }
    ...
    def _load_engineering_templates(self) -> Dict[str, Any]:
        ...
        return {
            "engineering_standards_advisor": {
                ...
                "tools": ["iraqi_building_codes", "technical_standards_database", "project_planning_tools"],
                "cultural_requirements": ["safety_priority", "quality_standards"],
                "language_support": ["technical_arabic", "engineering_terminology", "iraqi_arabic"]
            },
            "project_management_consultant": {
                ...
                "tools": ["project_templates", "resource_calculator", "timeline_planner"],
                "cultural_requirements": ["cultural_work_patterns", "local_regulations"],
                "language_support": ["project_management_arabic", "technical_terminology"]
            }
        }
    ...
    def generate_iraqi_agent(self, domain: str, specialist: str, custom_config: Optional[Dict] = None) -> Any:
        """
        ...
        if domain not in self.iraqi_domains:
            raise ValueError(f"Unsupported Iraqi domain: {domain}. Supported: {list(self.iraqi_domains.keys())}")
        
        if specialist not in self.iraqi_domains[domain]:
            raise ValueError(f"Unsupported specialist: {specialist} in domain: {domain}")
    ...
    def _validate_cultural_requirements(self, template: Dict[str, Any]):
        ...
        for requirement in cultural_reqs:
            if requirement == "islamic_compliance":
                ...
                if not self.compliance_validator.validate_content(template.get("backstory", "")):
                    raise ValueError("Agent template fails Islamic compliance validation")
                ...
                if "arabic" not in str(template.get("language_support", [])).lower():
                    raise ValueError("Agent template missing required Arabic language support")
    ...
    def create_iraqi_multi_agent_team(self, domains: List[str], task_description: str) -> Dict[str, Any]:
        """
        ...
        for domain in domains:
            ...
            if domain == "legal":
                ...
                agent = self.generate_iraqi_agent("medical", "medical_consultation_advisor")
            elif domain == "educational":
                agent = self.generate_iraqi_agent("educational", "curriculum_advisor")
            elif domain == "government":
                agent = self.generate_iraqi_agent("government", "citizen_services_advisor")
            elif domain == "business":
                agent = self.generate_iraqi_agent("business", "business_consultant")
            elif domain == "engineering":
                agent = self.generate_iraqi_agent("engineering", "engineering_standards_advisor")
