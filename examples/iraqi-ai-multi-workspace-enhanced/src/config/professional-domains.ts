...
export const legalDomainConfig: ProfessionalDomainConfig = {
  ...
  description: 'Iraqi legal practice management with Islamic jurisprudence and civil law compliance',
  descriptionAr: 'إدارة الممارسة القانونية العراقية مع الفقه الإسلامي والامتثال للقانون المدني',
  icon: '⚖️',
  color: '#1f2937',
  culturalCompliance: {
  ...
  features: [
    ...
    },
    {
      ...
      category: 'core',
      icon: '👥',
      permissions: ['view_clients', 'schedule_consultations', 'manage_appointments'],
    ...
    },
    {
      ...
      description: 'Integration with Iraqi court systems and calendar management',
      ...
      culturalRequirements: ['court-procedure-compliance', 'government-integration'],
    ...
    },
    {
      ...
      description: 'Automated fee calculation based on Iraqi Bar Association guidelines',
      descriptionAr: 'حساب الرسوم الآلي على أساس إرشادات نقابة المحامين العراقيين',
      category: 'premium',
      icon: '💰',
    ...
    },
    {
      ...
      description: 'Access to Iraqi legal precedents and Islamic jurisprudence database',
      descriptionAr: 'الوصول إلى السوابق القانونية العراقية وقاعدة بيانات الفقه الإسلامي',
      category: 'enterprise',
      icon: '🔍',
      permissions: ['research_access', 'precedent_search', 'jurisprudence_lookup'],
      culturalRequirements: ['islamic-jurisprudence', 'legal-precedent-validation'],
      securityLevel: 'enhanced',
    },
  ],
  specializations: [
    {
      ...
      description: 'Iraqi civil law practice including contracts, property rights, and civil disputes',
      descriptionAr: 'ممارسة القانون المدني العراقي بما في ذلك العقود وحقوق الملكية والنزاعات المدنية',
      requirements: ['Iraqi Bar Association membership', 'Civil law certification'],
      certifications: ['Iraqi Civil Law Certificate', 'Contract Law Specialization'],
    ...
    },
    {
      ...
      description: 'Business law, corporate law, and commercial transactions in Iraqi context',
      descriptionAr: 'قانون الأعمال وقانون الشركات والمعاملات التجارية في السياق العراقي',
      requirements: ['Commercial law certification', 'Business registration knowledge'],
      certifications: ['Iraqi Commercial Law Certificate', 'Corporate Law Specialization'],
    ...
    },
    {
      ...
      name: 'Family Law',
      nameAr: 'قانون الأسرة',
      description: 'Islamic family law and personal status matters according to Iraqi regulations',
      descriptionAr: 'قانون الأسرة الإسلامي ومسائل الأحوال الشخصية وفقا للأنظمة العراقية',
      requirements: ['Islamic jurisprudence knowledge', 'Family law certification'],
      certifications: ['Islamic Family Law Certificate', 'Personal Status Law Specialization'],
      experience: { minYears: 2, preferredYears: 5 },
    },
    {
      id: 'criminal-law',
      ...
      certifications: ['Iraqi Criminal Law Certificate', 'Defense Practice Specialization'],
  ...
  complianceRequirements: [
    {
      ...
      description: 'All legal advice must align with Islamic principles and Sharia law',
      descriptionAr: 'يجب أن تتماشى جميع الاستشارات القانونية مع المبادئ الإسلامية والشريعة الإسلامية',
      type: 'religious',
      severity: 'mandatory',
      validationRules: [
    ...
    },
    {
      ...
      description: 'Compliance with Iraqi Civil Code and procedural requirements',
    ...
    },
    {
      ...
      description: 'Strict client confidentiality and data protection requirements',
  ...
  governorateSupport: [
    'baghdad', 'basra', 'nineveh', 'arbil', 'najaf', 'karbala', 'babylon', 
    'anbar', 'diyala', 'kirkuk', 'saladin', 'wasit', 'maysan', 'muthanna', 
    'qadisiyyah', 'dhi_qar', 'sulaymaniyah', 'dahuk'
  ],
  templates: {
    defaultSettings: {
...
export const medicalDomainConfig: ProfessionalDomainConfig = {
  ...
  description: 'Iraqi healthcare practice management with Islamic medical ethics and patient care',
  descriptionAr: 'إدارة ممارسة الرعاية الصحية العراقية مع الأخلاق الطبية الإسلامية ورعاية المرضى',
  icon: '🏥',
  color: '#dc2626',
  culturalCompliance: {
    islamicCompliance: true,
  ...
  features: [
    {
      ...
      category: 'core',
      icon: '📋',
      permissions: ['view_patients', 'create_records', 'edit_records', 'medical_history'],
    ...
    },
    {
      ...
      description: 'Prayer-aware appointment scheduling with cultural considerations',
      descriptionAr: 'جدولة المواعيد مع مراعاة الصلاة والاعتبارات الثقافية',
      category: 'core',
      icon: '📅',
      permissions: ['schedule_appointments', 'manage_calendar', 'patient_communication'],
      culturalRequirements: ['prayer-time-awareness', 'gender-sensitive-scheduling'],
      securityLevel: 'enhanced',
    },
    {
      ...
      category: 'premium',
      icon: '💊',
      permissions: ['prescribe_medication', 'check_interactions', 'halal_verification'],
      culturalRequirements: ['halal-medication-compliance', 'islamic-medical-guidelines'],
      securityLevel: 'enhanced',
    },
    {
      id: 'medical-imaging',
    ...
    },
    {
      ...
      description: 'Secure telemedicine consultations with cultural considerations',
      descriptionAr: 'استشارات الطب عن بُعد الآمنة مع الاعتبارات الثقافية',
      category: 'premium',
      icon: '💻',
      permissions: ['video_consultation', 'remote_diagnosis', 'digital_prescription'],
      culturalRequirements: ['cultural-consultation-guidelines', 'gender-appropriate-care'],
      securityLevel: 'maximum',
    },
    {
      id: 'insurance-claims',
      ...
      category: 'enterprise',
      icon: '🏛️',
      permissions: ['submit_claims', 'track_payments', 'insurance_verification'],
      culturalRequirements: ['iraqi-insurance-compliance', 'government-integration'],
      securityLevel: 'government',
    },
  ],
  specializations: [
    {
      ...
      certifications: ['General Practice Certificate', 'Islamic Medical Ethics'],
    ...
    },
    {
      ...
      name: 'Pediatrics',
      nameAr: 'طب الأطفال',
      description: 'Specialized pediatric care with cultural family considerations',
      ...
      certifications: ['Pediatrics Board Certification', 'Family Care Specialization'],
    ...
    },
    {
      ...
      name: "Women's Health",
      nameAr: 'صحة المرأة',
      description: 'Specialized care for women with Islamic modesty and cultural considerations',
      descriptionAr: 'الرعاية المتخصصة للمرأة مع الحشمة الإسلامية والاعتبارات الثقافية',
      requirements: ['Gynecology specialization', 'Cultural sensitivity training'],
      certifications: ['OB/GYN Board Certification', 'Islamic Medical Ethics for Women'],
  ...
  complianceRequirements: [
    {
      ...
      description: 'All medical practice must align with Islamic medical ethics and principles',
      descriptionAr: 'يجب أن تتماشى جميع الممارسات الطبية مع الأخلاق والمبادئ الطبية الإسلامية',
      type: 'religious',
      severity: 'mandatory',
      validationRules: [
...
export const educationalDomainConfig: ProfessionalDomainConfig = {
  ...
  description: 'Iraqi educational institution management with Islamic education principles',
  ...
  features: [
    {
      ...
      category: 'core',
      icon: '👨‍🎓',
      permissions: ['view_students', 'manage_records', 'track_progress', 'generate_reports'],
      culturalRequirements: ['student-privacy', 'islamic-educational-guidelines'],
      securityLevel: 'enhanced',
    },
    {
      ...
      category: 'premium',
      icon: '📚',
      permissions: ['design_curriculum', 'manage_courses', 'islamic_studies_integration'],
      culturalRequirements: ['islamic-education-compliance', 'arabic-language-preservation'],
      securityLevel: 'enhanced',
    },
    {
      ...
      category: 'core',
      icon: '👨‍👩‍👧‍👦',
      permissions: ['parent_communication', 'progress_sharing', 'event_notifications'],
      culturalRequirements: ['family-involvement', 'cultural-communication-norms'],
      securityLevel: 'enhanced',
    },
  ],
  specializations: [
    {
      ...
      requirements: ['Islamic studies degree', 'Religious education certification'],
      certifications: ['Islamic Education Certificate', 'Quranic Studies Specialization'],
      experience: { minYears: 2, preferredYears: 5 },
    },
    {
      id: 'arabic-language',
      ...
      requirements: ['Arabic literature degree', 'Language instruction certification'],
      certifications: ['Arabic Language Teaching Certificate', 'Literature Specialization'],
  ...
  complianceRequirements: [
    {
      ...
      description: 'All educational content must align with Islamic values and principles',
      descriptionAr: 'يجب أن يتماشى جميع المحتوى التعليمي مع القيم والمبادئ الإسلامية',
      type: 'religious',
      severity: 'mandatory',
      validationRules: [
...
export const PROFESSIONAL_DOMAINS: Record<ProfessionalDomain, ProfessionalDomainConfig> = {
  ...
  business: {
    ...
    description: 'Iraqi business management with halal practices and Islamic finance',
    descriptionAr: 'إدارة الأعمال العراقية مع الممارسات الحلال والتمويل الإسلامي',
    icon: '💼',
    color: '#1f2937',
    culturalCompliance: {
      islamicCompliance: true,
    ...
    supportedLanguages: ['ar', 'en'],
    requiredValidations: ['business_registration', 'chamber_of_commerce_membership'],
  },
  engineering: {
    id: 'engineering',
    name: 'Engineering Services',
    nameAr: 'الخدمات الهندسية',
    description: 'Iraqi engineering practice with building codes and environmental compliance',
    descriptionAr: 'الممارسة الهندسية العراقية مع قوانين البناء والامتثال البيئي',
    icon: '🏗️',
    color: '#374151',
    culturalCompliance: {
      islamicCompliance: true,
  ...
  government: {
    ...
    description: 'Iraqi government institution management and public service delivery',
...
export function getDomainConfig(domain: ProfessionalDomain): ProfessionalDomainConfig {
  return PROFESSIONAL_DOMAINS[domain];
}

export function getDomainFeatures(domain: ProfessionalDomain): WorkspaceFeature[] {
  return getDomainConfig(domain).features;
}

export function getDomainSpecializations(domain: ProfessionalDomain): ProfessionalSpecialization[] {
  return getDomainConfig(domain).specializations;
}

export function getDomainComplianceRequirements(domain: ProfessionalDomain): ComplianceRequirement[] {
...
export function validateProfessionalLicense(
  ...
  return domainConfig.licenseTypes.includes(license.type) && license.status === 'active';
}
...
export function getSupportedLanguages(domain: ProfessionalDomain): ('ar' | 'en' | 'ku')[] {
