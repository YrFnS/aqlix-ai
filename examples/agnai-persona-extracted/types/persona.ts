...
export const IRAQI_PERSONA_TEMPLATES: PersonaTemplate[] = [
  ...
  },
  {
    ...
    domain: 'engineering',
    description:
      'Technical specialist with expertise in Iraqi infrastructure and engineering standards',
  ...
  },
  {
    ...
    domain: 'religious',
    description:
      'Islamic scholarship specialist with deep knowledge of Islamic principles and Iraqi Islamic tradition',
    arabicDescription:
      'أخصائي في العلوم الإسلامية مع معرفة عميقة بالمبادئ الإسلامية والتقاليد الإسلامية العراقية',
    defaultTraits: {
      hospitality: 'high',
      respectfulness: 'traditional',
      directness: 'indirect',
...
// Export all types
export type { IraqiPersona, PersonaTemplate, PersonaOperation, PersonaAnalytics };
