...
export interface ProfessionalDomainValidationRequest {
  ...
  context: {
    ...
    professional?: {
      // السياق المهني - Professional context
    ...
    temporal?: {
      // السياق الزمني - Temporal context
...
export interface ProfessionalDomainValidationResult {
  ...
  ethics_assessment: IraqiProfessionalEthics & {
    ...
    ethical_concerns: Array<{
      // مخاوف أخلاقية - Specific ethical concerns
      concern: string;
  ...
  regulatory_compliance: {
    ...
    compliance_gaps: Array<{
      // فجوات الامتثال - Compliance gaps
      regulation: string;
  ...
  accuracy_assessment: {
    ...
    fact_check_results: Array<{
      // نتائج التحقق من الحقائق - Fact-check results
      claim: string;
  ...
  recommendations: {
    required_changes: Array<{
      // التغييرات المطلوبة - Mandatory changes
      category:
        | "ethics"
        | "accuracy"
        | "compliance"
    ...
    professional_resources: Array<{
      // الموارد المهنية - Professional resources
      type:
        | "regulation"
        | "guideline"
        | "best_practice"
...
export const ProfessionalDomainValidationRequestSchema = z.object({
  ...
  context: z.object({
    ...
    professional: z
      .object({
        practitioner_level: z
          .enum(["student", "novice", "experienced", "expert"])
          .optional(),
        institution_type: z
          .enum(["academic", "government", "private", "non_profit"])
          .optional(),
        target_audience: z
          .enum(["general", "professional", "academic", "regulatory"])
          .optional(),
 ...
 */
export type ProfessionalDomainValidationRequestType = z.infer<
  typeof ProfessionalDomainValidationRequestSchema
>;
