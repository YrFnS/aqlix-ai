...
export class IraqiEventProcessor {
  ...
  applyIraqiEvents = (
    ...
    return events$.pipe(
      mergeMap((event: BaseEvent) =>
        this.processIraqiEvent(event, iraqiContext, {
          messages,
          state,
          applyMutation,
        }),
  ...
  private processIraqiEvent = async (
    ...
    try {
      ...
      const culturalValidation = await this.culturalValidator.validateEvent(
        event,
        iraqiContext,
      );
      ...
      switch (event.type) {
        case EventType.TEXT_MESSAGE_START:
          return this.handleIraqiTextMessageStart(
        ...
        case EventType.TEXT_MESSAGE_CONTENT:
          return this.handleIraqiTextMessageContent(
        ...
        case EventType.TEXT_MESSAGE_END:
          return this.handleIraqiTextMessageEnd(
        ...
        case EventType.TOOL_CALL_START:
          return this.handleIraqiToolCallStart(
        ...
        case EventType.TOOL_CALL_ARGS:
          return this.handleIraqiToolCallArgs(
        ...
        case EventType.TOOL_CALL_END:
          return this.handleIraqiToolCallEnd(
        ...
        case EventType.STATE_DELTA:
          return this.handleIraqiStateDelta(
            event as StateDeltaEvent,
            iraqiContext,
            context,
          );

        case EventType.STATE_SNAPSHOT:
          return this.handleIraqiStateSnapshot(
        ...
        case EventType.MESSAGES_SNAPSHOT:
          return this.handleIraqiMessagesSnapshot(
        ...
        case EventType.CUSTOM:
          return this.handleIraqiCustomEvent(
  ...
  private async handleIraqiTextMessageStart(
    ...
    if (containsArabic) {
      ...
      const rtlResult = await this.rtlProcessor.processText(
        event.content || "",
      );
      if (
        rtlResult.rtlAccuracy < this.config.arabicProcessing?.rtlAccuracy ||
        99
      ) {
        return of({
  ...
  private async handleIraqiTextMessageEnd(
    ...
    const finalValidation =
      await this.culturalValidator.validateCompleteMessage(event, iraqiContext);
  ...
  private async handleIraqiToolCallStart(
    ...
    if (!toolValidation.approved) {
      return of({
        toolValidationError:
          "Tool call not appropriate for Iraqi professional context",
  ...
  private async handleIraqiStateDelta(
    ...
    try {
      ...
      if (!deltaValidation.approved) {
        return of({
          stateDeltaValidationError:
            "State delta violates cultural constraints",
  ...
  private handleBaseTextMessageStart(
    event: any,
    context: any,
  ): Observable<IraqiAgentStateMutation> {
  ...
  private handleBaseTextMessageContent(
    event: any,
    context: any,
  ): Observable<IraqiAgentStateMutation> {
  ...
  private handleBaseTextMessageEnd(
    event: any,
    context: any,
  ): Observable<IraqiAgentStateMutation> {
  ...
  private handleBaseToolCallStart(
    event: any,
    context: any,
  ): Observable<IraqiAgentStateMutation> {
  ...
  private async handleIraqiToolCallArgs(
  ...
  private async handleIraqiToolCallEnd(
  ...
  private async handleIraqiStateSnapshot(
  ...
  private async handleIraqiMessagesSnapshot(
  ...
  private async handleIraqiCustomEvent(
    event: CustomEvent,
    iraqiContext: IraqiEventContext,
    context: any,
  ): Promise<Observable<IraqiAgentStateMutation>> {
