...
interface IIraqiGovernmentNode extends INodeType {
  ...
  ministry: 'health' | 'education' | 'interior' | 'justice' | 'finance' | 'planning';
...
*Empowering Iraqi government automation through culturally-intelligent, Islamically-compliant, and Arabic-first workflow solutions.*