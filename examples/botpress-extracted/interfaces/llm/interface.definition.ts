...
const iraqiLlmMessageSchema = z.object({
  ...
  culturalContext: z
    .object({
      ...
      regionalRelevance: z
        .array(
          z.enum(["baghdad", "basra", "mosul", "erbil", "najaf", "karbala"]),
        )
        .optional(),
    })
    .optional(),
  ...
  iraqiOptimizations: z
    .object({
      ...
      culturalComplianceLevel: z
        ...
        .default("moderate"),
      dialectPreference: z
        .enum(["iraqi", "standard_arabic", "user_preference"])
...
export default {
  ...
  description:
    "Enhanced LLM interface with Iraqi cultural context and professional domain support",
  ...
  actions: {
    ...
    generateCompletion: {
      ...
      description:
        "Generate LLM completion with Iraqi cultural context and validation",
    ...
    validateCultural: {
      ...
      description:
        "Validate content for Iraqi cultural and Islamic appropriateness",
    ...
    reviewProfessional: {
      ...
      description:
        "Review content for professional accuracy and standards compliance",
      ...
      input: {
        schema: z.object({
          ...
          reviewType: z
            .enum(["accuracy", "compliance", "ethics", "comprehensive"])
            .default("accuracy"),
