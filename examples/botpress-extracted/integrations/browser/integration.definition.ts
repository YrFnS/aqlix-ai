...
const iraqiFormDataSchema = z.object({
  personalInfo: z.object({
    ...
    nationalId: z
      .string()
      .regex(/^\d{12}$/, "رقم الهوية يجب أن يكون 12 رقم")
      .optional(), // National ID must be 12 digits
    phoneNumber: z
      .string()
      .regex(/^(\+964|0)(77|78|79|75|73)\d{8}$/, "رقم الهاتف العراقي غير صحيح")
      .optional(), // Invalid Iraqi phone number
    ...
    civilStatus: z
      ...
      .optional(),
    religion: z
      .enum(["muslim", "christian", "other", "مسلم", "مسيحي", "أخرى"])
      .optional(),
  }),
...
export default {
  ...
  description:
    "Enhanced browser automation for Iraqi government websites and Arabic forms",
  ...
  actions: {
    ...
    navigateToGovSite: {
      ...
      description:
        "Navigate to Iraqi government website with optimized settings",
    ...
    fillIraqiForm: {
      ...
      description:
        "Automatically fill Iraqi government forms with cultural validation",
    ...
    checkGovServiceStatus: {
      ...
      description:
        "Check availability and status of Iraqi government online services",
    ...
    extractIraqiDocumentData: {
      ...
      description:
        "Extract and structure data from Iraqi government documents and forms",
    ...
    interactWithIraqiBankSite: {
      ...
      description:
        "Safely interact with Iraqi banking websites for account information",
