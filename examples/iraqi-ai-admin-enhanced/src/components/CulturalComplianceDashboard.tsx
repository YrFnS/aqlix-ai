...
const CulturalComplianceDashboard: React.FC = () => {
        ...
        islamic: {
          ...
          categories: [
            ...
            },
            {
              ...
              severity: "low",
              examples: [
                "Meeting scheduled during Maghrib",
                "Notification during prayer",
              ],
              trend: -8.1,
            },
          ],
          ...
          categories: [
            {
              ...
              examples: [
                ...
                "Inappropriate family references",
              ],
              trend: 12.3,
            },
            {
              ...
              severity: "low",
              examples: [
                "Informal address to elders",
                "Casual religious references",
              ],
              trend: -5.7,
            },
          ],
    ...
    try {
      const mockAlerts: ComplianceAlert[] = [
        ...
        },
        {
          ...
          severity: "medium",
          message:
            "Cultural appropriateness violations increasing in Baghdad region",
        ...
        },
        {
          ...
          severity: "critical",
          message:
            "Legal domain compliance critical - immediate attention required",
    ...
    const data = [
      {
        name: "Islamic",
        nameAr: "إسلامي",
        value: metrics.islamic.score,
        target: COMPLIANCE_TARGETS.islamic,
      },
      {
        name: "Cultural",
        nameAr: "ثقافي",
        value: metrics.cultural.score,
        target: COMPLIANCE_TARGETS.cultural,
      },
      {
        name: "Professional",
        nameAr: "مهني",
        value: metrics.professional.score,
        target: COMPLIANCE_TARGETS.professional,
      },
      {
        name: "Arabic",
        nameAr: "عربي",
        value: metrics.arabic.accuracy,
        target: COMPLIANCE_TARGETS.arabic,
      },
    ];
  ...
  const renderViolationsPieChart = () => {
    ...
    const data = [
      {
        name: "Islamic",
        value: metrics.islamic.violations,
        color: COLORS.islamic,
      },
      {
        name: "Cultural",
        value: metrics.cultural.violations,
        color: COLORS.cultural,
      },
      {
        name: "Professional",
        value: metrics.professional.violations,
  ...
  const renderAlertsSection = () => {
    const filteredAlerts = alerts.filter((alert) => {
      if (
        ...
        alert.severity !== filters.alertSeverity
      ) {
        return false;
      }
      if (
        ...
        alert.governorate &&
        alert.governorate !== filters.governorate
      ) {
        return false;
      }
      if (
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setFilters((prev) => ({ ...prev, governorate: value }))
          }
        >
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>{renderComplianceChart()}</CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle>Violation Distribution</CardTitle>
              </CardHeader>
              <CardContent>{renderViolationsPieChart()}</CardContent>
            </Card>
          </div>
        </TabsContent>
        ...
        <TabsContent value="regional" className="space-y-4">
          <Card>
            ...
            <CardContent>{renderRegionalCompliance()}</CardContent>
          </Card>
        </TabsContent>
