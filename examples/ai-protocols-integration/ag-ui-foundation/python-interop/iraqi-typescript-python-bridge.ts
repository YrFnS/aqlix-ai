...
export const IraqiLanguageEnum = z.enum(['arabic', 'english', 'kurdish', 'mixed']);
export type IraqiLanguage = z.infer<typeof IraqiLanguageEnum>;

export const IraqiDialectEnum = z.enum(['iraqi', 'standard', 'gulf', 'levantine', 'maghrebi', 'egyptian']);
export type IraqiDialect = z.infer<typeof IraqiDialectEnum>;

export const IraqiRoleEnum = z.enum(['developer', 'system', 'assistant', 'user', 'tool']);
...
export class IraqiTypescriptPythonBridge {
   ...
   */
  static convertMessageToPythonFormat(message: IraqiMessage): Record<string, any> {
    const result = {
      ...message,
      __type: 'IraqiMessage',
   ...
   */
  static convertPythonMessageToTypescript(pythonData: Record<string, any>): IraqiMessage {
  ...
  static createAgentInputForPython(
    ...
    const input: IraqiRunAgentInput = {
      ...
      culturalValidationStrictMode: culturalContext?.culturalValidation || false,
   ...
   */
  static processPythonAgentResponse(pythonResponse: Record<string, any>): IraqiAgentResponse {
