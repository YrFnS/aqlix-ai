...
export const IraqiAssistantMessageSchema = IraqiBaseMessageSchema.extend({
  ...
  aiContext: z.object({
    ...
    islamicKnowledgeLevel: z.enum(["basic", "intermediate", "advanced"]).optional(),
    arabicCapabilities: z.object({
...
export const IraqiUserMessageSchema = IraqiBaseMessageSchema.extend({
  ...
  userPreferences: z.object({
    preferredLanguage: z.enum(["arabic", "english", "mixed"]).default("english"),
    ...
    professionalContext: z.enum([
      "legal", "medical", "educational", "business",
      "technology", "finance", "personal", "general"
    ]).optional(),
...
export const IraqiContextSchema = z.object({
  ...
  culturalRelevance: z.object({
    islamicRelevance: z.enum(["high", "medium", "low", "none"]).default("none"),
    culturalImportance: z.enum(["critical", "important", "moderate", "low"]).default("low"),
    arabicContentPresent: z.boolean().default(false),
    professionalDomain: z.enum([
      "legal", "medical", "educational", "business",
      "technology", "finance", "religious", "general"
    ]).optional()
  }).optional()
});
...
export const IraqiRunAgentInputSchema = z.object({
  ...
  iraqiAgentConfig: z.object({
    // Cultural configuration
    culturalSettings: z.object({
      strictIslamicCompliance: z.boolean().default(false),
      culturalValidationLevel: z.enum(["strict", "moderate", "flexible"]).default("moderate"),
      arabicProcessingEnabled: z.boolean().default(false),
...
export interface ProfessionalDomainContext {
  domain: 'legal' | 'medical' | 'educational' | 'business' | 'technology' | 'finance' | 'religious' | 'general';
...
export const DEFAULT_IRAQI_AGUI_CONFIG: IraqiAGUIConfiguration = {
  ...
  professional: {
    ...
    supportedDomains: ['legal', 'medical', 'educational', 'business', 'technology', 'finance'],
