...
class Folder(FolderBase, table=True):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "name", name="unique_folder_name_per_user"),
    )
    ...
    children: List["Folder"] = Relationship(
        back_populates="parent", sa_relationship_kwargs={"cascade": "delete"}
    )
    flows: List["Flow"] = Relationship(
        back_populates="folder", sa_relationship_kwargs={"cascade": "delete"}
    )
