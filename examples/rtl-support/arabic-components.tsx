...
export const ArabicInput: React.FC<ArabicInputProps> = ({
  ...
  const baseClasses =
    "w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-arabic";
...
export const ArabicButton: React.FC<ArabicButtonProps> = ({
  ...
  const baseClasses =
    "font-arabic rounded-lg focus:outline-none focus:ring-2 transition-colors";
...
export const LanguageToggle: React.FC<LanguageToggleProps> = ({
  ...
  return (
    <div
      className={`flex rounded-lg border border-gray-300 overflow-hidden ${className}`}
    >
      <button
