...
export const IraqiAgentCardSchema = z.object({
  ...
  professionalDomains: z.array(z.enum([
  ...
  dialects: z.array(z.enum(['iraqi', 'standard', 'gulf', 'levantine'])).default(['iraqi']),
...
export const AgentMessageSchema = z.object({
  ...
  agentId: z.string(),
  type: z.enum([
    'text', 'cultural_validation', 'arabic_processing', 
    'islamic_compliance', 'professional_analysis', 
    'payment_processing', 'security_scan', 'ui_generation'
  ]),
  content: z.string(),
