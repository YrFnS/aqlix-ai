...
export const IraqiPaymentGatewayEnum = z.enum([
  "ZainCash",
  "FastPay",
  "NassWallet",
  "QiCard",
...
export type IslamicFinanceCompliance = z.infer<
  typeof IslamicFinanceComplianceSchema
>;
...
export type PaymentProcessingResult = z.infer<
  typeof PaymentProcessingResultSchema
>;
