...
log_level = logging.DEBUG if os.getenv('IRAQI_DEBUG', 'false').lower() == 'true' else logging.INFO
logging.basicConfig(
    level=log_level,
...
def check_environment():
    ...
    cultural_compliance = os.getenv('IRAQI_CULTURAL_COMPLIANCE', 'true').lower() == 'true'
