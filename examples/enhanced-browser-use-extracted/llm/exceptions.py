...
class ModelProviderError(Exception):
    ...
    def has_iraqi_ai_failures(self) -> bool:
        ...
        return (
            self.cultural_validation_failed
            or self.arabic_processing_failed
            or self.islamic_compliance_failed
            or self.iraqi_dialect_processing_failed
        )
...
class ModelRateLimitError(ModelProviderError):
    ...
    def __init__(
        self, message: str, model: str, retry_after: Optional[int] = None, **kwargs
    ):
        """
...
class CulturalValidationError(ModelProviderError):
    ...
    def __init__(
        ...
        """
        super().__init__(message, model, cultural_validation_failed=True)
    ...
    def __str__(self) -> str:
        base_msg = super().__str__()
        score_info = (
            f"Score: {self.validation_score:.1%} (required: {self.required_score:.1%})"
        )
...
class IslamicComplianceError(ModelProviderError):
    ...
    def __init__(
        ...
        """
        super().__init__(message, model, islamic_compliance_failed=True)
