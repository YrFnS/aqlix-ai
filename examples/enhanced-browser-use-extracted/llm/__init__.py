...
_LAZY_IMPORTS = {
    'ChatAnthropic': ('enhanced_browser_use_extracted.llm.anthropic.chat', 'ChatAnthropic'),
    'ChatAnthropicBedrock': ('enhanced_browser_use_extracted.llm.aws.chat_anthropic', 'ChatAnthropicBedrock'),
    'ChatAWSBedrock': ('enhanced_browser_use_extracted.llm.aws.chat_bedrock', 'ChatAWSBedrock'),
    'ChatAzureOpenAI': ('enhanced_browser_use_extracted.llm.azure.chat', 'ChatAzureOpenAI'),
    'ChatDeepSeek': ('enhanced_browser_use_extracted.llm.deepseek.chat', 'ChatDeepSeek'),
    ...
    'ChatOpenRouter': ('enhanced_browser_use_extracted.llm.openrouter.chat', 'ChatOpenRouter'),
}
...
def __getattr__(name: str):
    ...
    if name in _LAZY_IMPORTS:
        ...
        try:
            ...
            try:
                original_path = module_path.replace('enhanced_browser_use_extracted.llm', 'browser_use.llm')
