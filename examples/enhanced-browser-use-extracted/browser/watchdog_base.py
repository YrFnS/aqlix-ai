...
class BaseWatchdog(BaseModel):
    ...
    @staticmethod
    def attach_handler_to_session(browser_session: Any, event_class: type[BaseEvent[Any]], handler) -> None:
        """
        ...
        wrapped_handler.__name__ = f'{watchdog_class_name}_{handler.__name__}_{id(handler)}'
    ...
    async def emit_iraqi_cultural_violation(self, content: str, violation_type: str, severity: str = 'medium'):
    ...
    async def emit_iraqi_security_threat(self, threat_type: str, url: str, details: dict):
    ...
    async def emit_iraqi_portal_access(self, url: str, portal_type: str, access_result: str):
    ...
    async def emit_arabic_content_processed(self, content: str, processing_type: str, result: dict):
