...
import { ArrowRight, MessageSquareX } from "lucide-react";
    ...
    <div className="mx-auto flex min-h-[70vh] max-w-3xl items-center justify-center">
      <section className="w-full rounded-3xl border border-border/70 bg-card p-6 text-center shadow-lg shadow-foreground/5 sm:p-10">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary text-primary">
          <MessageSquareX className="h-6 w-6" aria-hidden="true" />
        </div>
        <p className="mt-6 text-sm font-semibold text-primary">
          P2 · Missing or forbidden
        </p>
        ...
        <p className="mx-auto mt-4 max-w-xl text-sm leading-8 text-muted-foreground">
          قد تكون المحادثة حُذفت، أو أن حسابك لا يملك عضوية في مساحة العمل. لا
          تكشف الصفحة أي تفاصيل تميّز بين السجل المفقود والسجل المحمي.
        </p>
