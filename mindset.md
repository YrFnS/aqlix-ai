...
_Non-Negotiable Guidelines for AI Agents on this Project_
...
- Never assume, add, or change features, infrastructure, or logic without a clear request in the spec or ops doc.
...
- Ignore "industry best practices" unless specifically requested for _this_ project.
- Only automate (security, audits, recovery, etc.) when explicitly asked.

### 2. SLC Standard - Simple, Lovable, Complete
...
- Every feature, flow, or proposal should be finished enough that it solves the _actual problem_ it was intended for.
- No half-built endpoints, no "future hooks," no unfinished UI.
- Don't leave TODOs, dead code, or incomplete implementations unless specifically asked to scaffold something out.

**Before you suggest or build anything, ask:**

1. Is this the simplest version?
2. Is this something the solo dev will love, use, or be proud to own?
3. Is it complete and shippable, or am I leaving work unfinished?
...
- Only rebuild from scratch if specifically requested _and_ there's a documented need that existing solutions cannot address.
...
You're not building for a boardroom. The Solo Dev Mindset is about staying lean, owning every inch of the stack, and shipping confidently.
...
Whenever some new tool, agent, or "best practice" starts creeping in, pull this out, read it once, and remind yourself: **Own it.**
