...
**Success Rate**: 95%+ when properly orchestrated
...
**Next Context**: "Feature requirements with Iraqi market analysis, cultural priorities, and business validation framework"
...
**Next Context**: "Cultural compliance assessment with Islamic validation, political neutrality confirmation, and professional appropriateness verification"
...
**Duration**: 3-4 hours
**Input Context**: `iraqi-requirements.md`, `cultural-validation.md`
...
2. **Visual Design Phase** (2 hours)
   - Agent: `iraqi-ui-designer`
   - Action: Create RTL-first visual designs
   - Input: User research + cultural validation
   - Output: Visual design specifications

3. **Interaction Design Phase** (1 hour)
   - Agent: `iraqi-interaction-designer`
   - Action: Design culturally-appropriate interactions
   - Input: Visual designs + user patterns
...
**Next Context**: "Complete design specifications with RTL-first approach, Iraqi cultural patterns, and user-centered interaction design"
...
**Next Context**: "Technical implementation approach with cultural context integration, Arabic processing pipeline, and Islamic compliance architecture"
...
**Duration**: 2-3 hours
**Input Context**: All previous contexts + `implementation-plan.md`
...
1. **Cultural Testing** (1 hour)
   ...
   - Validation: Iraqi user personas

2. **Arabic Language Testing** (1 hour)
   - Agent: `iraqi-arabic-tester`
   - Focus: RTL rendering, dialect recognition
   - Validation: Cross-browser compatibility

3. **Payment Testing** (1 hour, if applicable)
   - Agent: `iraqi-payment-tester`
   - Focus: Gateway integration, security
...
- Payment security compliant (100%)

**Completion Context**: "Feature fully validated with comprehensive testing, cultural acceptance confirmed, and technical implementation verified"
...
- `iraqi-patterns.md`: User behavior insights
...
2. **Design Complexity Overflow** (Phase 3)
   - Recovery: Simplify design scope
   - Fallback: Use proven design patterns
   - Duration Impact: +1-2 hours

3. **Technical Integration Issues** (Phase 4)
   - Recovery: Alternative architecture approach
...
- **Fallback**: Always have alternative approaches ready
...
- ✅ User testing validates acceptance

This workflow template ensures comprehensive feature development that honors Iraqi cultural values while maintaining technical excellence and user satisfaction.
