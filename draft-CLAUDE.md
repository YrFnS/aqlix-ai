...
- **Business Analysis**: Use iraqi-business-analyst for Iraqi business process analysis and stakeholder requirement coordination
- **Product Management**: Use iraqi-product-manager for Iraqi market analysis, feature prioritization, and cultural constraints
- **AI Development**: Use iraqi-ai-agent-architect for PydanticAI development with Iraqi cultural context and Arabic NLP
- **DevOps Tasks**: Use iraqi-devops-engineer for Iraqi infrastructure, deployment automation, and monitoring systems
