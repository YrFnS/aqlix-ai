...
- **external-service-coordinator:** Multi-service integration and health monitoring
...
- **Performance Optimization:** <200ms cultural validation, optimized context management
- **Professional Integration:** Iraqi legal, medical, educational, business domain support
- **Real-time Monitoring:** Agent performance tracking and error handling
...
from core.cultural_intelligence import IraqiCulturalContext

cultural_agent = Agent(
    'gpt-4o',
    system_prompt="""You are an Iraqi cultural validation specialist.
    Validate content for Islamic compliance and Iraqi cultural appropriateness.""",
    deps_type=IraqiCulturalContext
)

# Multi-Agent Coordination
from core.orchestration import IraqiWorkflowOrchestrator
...
- **Error Recovery:** Graceful fallback and error handling across agent chains
...
- **PydanticAI Framework:** https://ai.pydantic.dev/ - PydanticAI framework documentation and setup
- **Agent Architecture:** PydanticAI agent configuration and architecture patterns
- **Conversation Management:** AI conversation handling and state management patterns
- **Response Validation:** AI response validation and structured output patterns
- **Cultural AI Integration:** Best practices for cultural context integration with AI agents
...
- **Technical Specialists:** UI/UX, security, DevOps, architecture, debugging
...
- **Load Balancing:** Distribute workload across specialized agents
...
- **Regional Adaptation:** Baghdad, Basra, Mosul, Erbil cultural variations
...
- **Context Persistence:** Session and cross-session context management
- **Performance Optimization:** <200ms response times with cultural validation

---

## SECURITY & BEST PRACTICES:

**PydanticAI agent security considerations:**

- **Agent Security:** Secure PydanticAI agent configuration and deployment
- **Response Security:** Secure AI response validation and content filtering
- **Context Security:** Secure AI conversation context handling and storage
- **Cultural Security:** Secure cultural context integration and validation

---

## COMMON GOTCHAS:

**PydanticAI agent development challenges:**

- **Agent Configuration Complexity:** Complex PydanticAI agent setup and configuration
- **Cultural Context Integration:** Integrating Iraqi cultural context with AI agents
- **Conversation State Management:** Managing AI conversation state and context persistence
- **Response Validation Accuracy:** Accurate AI response validation and compliance checking
- **Performance Optimization:** Optimizing AI agent performance and response times
...
- **Security Agents:** 100% security compliance, threat detection accuracy
- **UI/UX Agents:** WCAG 2.1 AA compliance with Arabic RTL support
...
- **Context Management:** Validate context optimization and persistence
...
- **Professional Domains:** Validate Iraqi-specific professional functionality
...
- **Performance Monitoring:** APM integration for real-time agent performance metrics
...
- **Parallel Processing:** Multi-agent coordination for complex workflows
- **Resource Management:** Efficient agent resource allocation and scaling
...
**Advanced complexity selected** because the Iraqi AI agent system includes 21 specialized agents, multi-agent coordination, cultural intelligence framework, Arabic language processing, professional domain integration, and complex workflow orchestration.

---

**This micro-initial provides comprehensive requirements for deploying the complete Iraqi AI agent ecosystem with 21 specialized agents, cultural intelligence integration, and multi-agent coordination for the Iraqi AI Chat System.**
